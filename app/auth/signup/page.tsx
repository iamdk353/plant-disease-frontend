...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("send request to backend to register the user ");
      try {
        const baseUrl = (
        ...
        console.error("Backend database registration failed:", backendErr);
      }
        ...
        <section className="hidden lg:flex relative overflow-hidden flex-col justify-between p-16 bg-surface-container-low">
          <div className="relative z-10">
            ...
            <h1 className="font-headline text-5xl font-extrabold text-on-surface tracking-tighter leading-tight max-w-md">
              ...
              <span className="text-primary">precision intelligence.</span>
            </h1>
            <p className="mt-6 text-on-surface-variant text-lg max-w-sm leading-relaxed">
              Join over 10,000 farmers using AI to optimize crop yields and
              sustainable growth.
            </p>
          </div>
          <div className="relative z-10">
          ...
          <div className="absolute inset-0 z-0">
            <img
              ...
              alt="lush green vegetable garden rows with sunlight filtering through leaves in a modern high-end greenhouse setting"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuBX61MNs2no4NncGU1C9mLDyw2bCiB5N4Y4mzRvBuhLyigcNZV9-u8rby3MeU4EAyz0dMriJqozhW_ako8xAJ1Je2pj7dgVa2ztcieRBLmN5D-wjTibcBDxcaNbdfkfbTki1DAr9xjEGAuaWICbDgAYG3FTCSGC59kvgisoHuFfysIEmcinlfBhJNVvJcOPjo3RsihbIifwgsceoxnV4tdi5D7UiwfPrfO1B7DOHdPcj03WvfcsQTk5828YXfItzeCLxr4fwKPJ-xxb"
            />
          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-10 text-center lg:text-left">
              ...
              <p className="text-on-surface-variant">
                Simple, sustainable, and supported growth starts here.
              </p>
            </div>
            {error && (
            ...
            <div className="mt-10 text-center">
              <p className="text-on-surface-variant font-medium">
                ...
                <Link
                  className="text-primary font-bold hover:underline ml-1 underline-offset-4 decoration-2"
                  href="/auth/login"
                >
                  Login
                </Link>
            ...
            <div className="mt-12 p-6 bg-surface-container-low rounded-xl border-0 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">
                  Your agricultural data is encrypted and remains your
                  intellectual property. We prioritize your privacy above all
                  else.
                </p>
              </div>
            </div>
